...
const App: React.FC = () => {
  ...
  const deleteCondo = (id: string) => {
    if (confirm("Sei sicuro di voler eliminare definitivamente questo condominio?")) {
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 text-slate-900">
      ...
      <main className="flex-1 ml-64 p-8 overflow-y-auto">
        <div className="flex justify-between items-center mb-10 bg-white sticky top-0 z-20 -mx-8 px-8 py-4 border-b border-slate-200 shadow-sm">
            ...
            <div className="relative group">
              <button className="flex items-center gap-3 bg-white border border-slate-200 px-4 py-2 rounded-full shadow-sm hover:border-emerald-300 transition-all min-w-[200px]">
                ...
                <div className="text-left flex-1">
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-0.5">Focus</p>
